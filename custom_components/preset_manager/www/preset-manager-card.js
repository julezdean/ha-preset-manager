...
`;function ut(e){return e&&Ve("ha-icon")?I`<ha-icon .icon=${e} aria-hidden="true"></ha-icon>`:F}function mt(e){const{config:t}=e;if(!t.header.visible)return F;const s=function(e){const t=e.config.header.icon;if(!1===t)return null;if(t)return t;const s=Ze(e.hass,e.subject);return s?.icon?s.icon:"preset_mode"===e.subject.kind?"mdi:state-machine":"mdi:tune-variant"}(e),i=!1===t.header.subtitle?null:t.header.subtitle??function(e){const{hass:t,subject:s}=e,i=Ze(t,s),n=i?.name??dt(t,"no_mode");if("preset_mode"===s.kind){const{presetMode:e}=s;if(e.source_entity){const s=t.states[e.source_entity];return`${n} · ${dt(t,"follows",{entity:s?.attributes.friendly_name??e.source_entity})}`}return n}return s.presetMode?!1===tt(t,s)?`${n} · ${dt(t,"manual")}`:n:`${n} · ${dt(t,"no_preset_mode")}`}(e),n=t.header.icon_color??function(e){const t=Ze(e.hass,e.subject);return t?e.config.modes.colors[t.key]:void 0}(e),{tappable:r}=e;return I`
  ...
  `}function ft(e,t){const s=et(e.subject);s&&e.call(e.hass.callService("preset_manager","set_active_mode",{mode:t},{entity_id:s}))}function _t(e){const t=Ye(e.subject);if(!t.length)return I`<div class="note">${dt(e.hass,"no_modes")}</div>`;const s=Ge(e.hass,e.subject);if("preset_mode"===e.subject.kind)return function(e,t,s){const{config:i}=e;return I`
    <div class="chips" role="list">
      ${t.map(e=>{const t=i.modes.colors[e.key];return I`
          <span
            class="chip"
            role="listitem"
  ...
  `}(e,t,s);const i=null!==st(e.hass,e.subject);return"dropdown"===e.config.modes.style?function(e,t,s,i){return I`
    <select
      class="select-input"
  ...
  `}(e,t,s,i)}function vt(e){const t=function(e){const{hass:t,subject:s,config:i}=e;if(!i.modes.automatic)return F;const n=Qe(s);if(!n)return F;const r=tt(t,s),o=dt(t,"mode_automatic");return I`
    <label class="toolbar">
  ...
  `}(e),s=function(e){const t=e.config.modes.visible;return"manual"===t?null===st(e.hass,e.subject):"never"!==t}(e)?_t(e):F;return t===F&&s===F?F:I`<div class="section rows">${t}${s}</div>`}function bt(e,t,s,i,n){if(e.stage)return void e.stage(t.entity_id,{service:s,data:i,display:n});const r=t.entity_id.split(".",1)[0];e.call(e.hass.callService(r,s,i,{entity_id:t.entity_id}))}function gt(e,t){const s=e.draft?.get(t.entity_id)?.display;return void 0!==s?{disabled:!1,empty:!1,staged:s}:{disabled:(i=t.state,void 0===i||i===He),empty:De(t.state),staged:void 0};var i}function $t(e,t,s){const i=e.attributes[t];return null==i?s:i}function yt(e,t,s,i){const{disabled:n,empty:r,staged:o}=gt(e,t);let a=o??(r?"":t.state);return void 0===o&&("datetime"===i&&(a=r?"":function(e){const t=new Date(e);if(Number.isNaN(t.getTime()))return"";const s=e=>String(e).padStart(2,"0");return`${t.getFullYear()}-${s(t.getMonth()+1)}-${s(t.getDate())}T${s(t.getHours())}:${s(t.getMinutes())}`}(t.state)),"time"===i&&(a=a.slice(0,5))),I`
    <input
      ...
      .value=${a}
      ?disabled=${n}
      @change=${s=>{const n=s.target.value;n&&bt(e,t,"set_value","date"===i?{date:n}:"time"===i?{time:`${n}:00`}:{datetime:`${n.replace("T"," ")}:00`},n)}}
    />
  `}function wt(e,t,s,i){if(!s)return I`<span class="row-value muted">
      ${dt(e.hass,"unavailable")}
    </span>`;switch(t){case"number":return function(e,t,s){const{disabled:i,empty:n,staged:r}=gt(e,t),o=$t(t,"min",0),a=$t(t,"max",100),c=$t(t,"step",1),l=t.attributes.unit_of_measurement??"",d=r??t.state,h=n?"":d,p=s=>{const i=s.target.valueAsNumber;Number.isNaN(i)||bt(e,t,"set_value",{value:i},String(i))};return"slider"===$t(t,"mode","box")?I`
      <input
        class="slider"
        type="range"
        aria-label=${s}
    ...
    <input
      ...
      ?disabled=${i}
      @change=${p}
      @keydown=${s=>{const n="ArrowUp"===s.key?1:"ArrowDown"===s.key?-1:0;if(!n||i)return;s.preventDefault();const r=s.target,l=Number.isNaN(r.valueAsNumber)?o:r.valueAsNumber,d=Math.min(a,Math.max(o,l+n*c));if(d===l)return;const h=(String(c).split(".")[1]??"").length;r.value=d.toFixed(h),bt(e,t,"set_value",{value:Number(r.value)},r.value)}}
    />
  ...
  `}(e,s,i);case"boolean":return function(e,t,s){const{disabled:i,empty:n,staged:r}=gt(e,t);return I`
    <label class="switch">
      <input
        ...
        .indeterminate=${n}
        ?disabled=${i}
        @change=${s=>{const i=s.target.checked;bt(e,t,i?"turn_on":"turn_off",{},i?"on":"off")}}
      />
    </label>
  `}(e,s,i);case"select":return function(e,t,s){const{disabled:i,empty:n,staged:r}=gt(e,t),o=$t(t,"options",[]),a=r??t.state;return I`
    <select
      ...
      aria-label=${s}
      ?disabled=${i}
      @change=${s=>{const i=s.target.value;bt(e,t,"select_option",{option:i},i)}}
    >
  ...
  `}(e,s,i);case"text":return function(e,t,s){const{disabled:i,empty:n,staged:r}=gt(e,t),o=t.attributes.pattern;return I`
    <input
      ...
      .value=${n?"":r??t.state}
      ?disabled=${i}
      @change=${s=>{const i=s.target.value;bt(e,t,"set_value",{value:i},i)}}
    />
  ...
  `}(i)} ${function(e){if(!e.config.footer.visible)return F;const t=e.config.footer.content.map(t=>jt(e,t)).filter(e=>null!==e);return t.length?I`
