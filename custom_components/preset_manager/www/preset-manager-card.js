...
`;function ct(e){return e&&Ve("ha-icon")?W`<ha-icon .icon=${e} aria-hidden="true"></ha-icon>`:V}function lt(e){const{visible:t}=e.config.modes;return"never"!==t&&("always"===t||"preset_mode"===e.subject.kind)}function dt(e,t,s){const i=t.entities.active_mode;i&&e.call(e.hass.callService("preset_manager","set_active_mode",{mode:s},{entity_id:i}))}function ht(e){if(!lt(e))return V;const t=Ke(e.subject);if(!t.length)return W`<div class="section note">
      ${rt(e.hass,"no_modes")}
    </div>`;const s=function(e){return e.subject.presetMode}(e),i=Je(e.hass,e.subject),n=null!==Ze(e.hass,s),r=function(e,t){const s=Ze(e.hass,t);if("automatic"===s)return rt(e.hass,"automatic_hint");if("external"===s&&t?.source_entity){const s=e.hass.states[t.source_entity];return rt(e.hass,"external_hint",{entity:s?.attributes.friendly_name??t.source_entity})}return"missing"===s&&"preset"===e.subject.kind?rt(e.hass,"orphaned"):null}(e,s);return W`
    <div class="section">
  ...
  `}(e,t,i,s,n):function(e,t,s,i,n){const{config:r}=e;return W`
    <div class="chips" role="group">
      ${t.map(t=>{const o=t.key===s,a=r.appearance.state_color?r.modes.colors[t.key]:void 0;return W`
          <button
            class="chip"
            type="button"
  ...
  `}function pt(e,t,s,i){const n=t.entity_id.split(".",1)[0];e.call(e.hass.callService(n,s,i,{entity_id:t.entity_id}))}function mt(e,t,s){const i=e.attributes[t];return null==i?s:i}function ft(e,t,s,i){const n=Re(t.state);let r=n?"":t.state;return"datetime"===i&&(r=n?"":function(e){const t=new Date(e);if(Number.isNaN(t.getTime()))return"";const s=e=>String(e).padStart(2,"0");return`${t.getFullYear()}-${s(t.getMonth()+1)}-${s(t.getDate())}T${s(t.getHours())}:${s(t.getMinutes())}`}(t.state)),"time"===i&&(r=r.slice(0,5)),W`
    <input
      class="date-input"
    ...
    />
  `}function _t(e,t,s,i){if(!s)return W`<span class="row-value muted">
      ${rt(e.hass,"unavailable")}
    </span>`;switch(t){case"number":return function(e,t,s){const i=Re(t.state),n=mt(t,"min",0),r=mt(t,"max",100),o=mt(t,"step",1),a=t.attributes.unit_of_measurement??"",c=i?"":t.state,l=s=>{const i=s.target.valueAsNumber;Number.isNaN(i)||pt(e,t,"set_value",{value:i})};return"slider"===mt(t,"mode","box")?W`
      <input
        class="slider"
        type="range"
        aria-label=${s}
    ...
    <input
      ...
      @change=${l}
    />
    ${a?W`<span class="row-value">${a}</span>`:V}
  `}(e,s,i);case"boolean":return function(e,t,s){const i=Re(t.state);return W`
    <label class="switch">
      <input
        type="checkbox"
        role="switch"
  ...
  `}(e,s,i);case"select":return function(e,t,s){const i=Re(t.state),n=mt(t,"options",[]);return W`
    <select
      class="select-input"
      aria-label=${s}
      ?disabled=${i}
    ...
    >
      ${i?W`<option value="" selected>—</option>`:V}
      ${n.map(e=>W`
  ...
  `}(e,s,i);case"text":return function(e,t,s){const i=Re(t.state),n=t.attributes.pattern;return W`
    <input
      class="text-input"
    ...
    />
  `}(e,s,i);case"date":return ft(e,s,i,"date");case"time":return ft(e,s,i,"time");case"datetime":return ft(e,s,i,"datetime");default:return W`<span class="row-value muted">
        ${rt(e.hass,"not_editable")}
      </span>`}}function vt(e,t){const s=e.config.values.parameters,i=new Map((s??[]).map(e=>[e.parameter,e]));return function(e,t){if(!t)return e.parameters;const s=new Map(e.parameters.map(e=>[e.key,e]));return t.map(e=>s.get(e)).filter(e=>void 0!==e)}(t,s?s.map(e=>e.parameter):null).map(e=>{const t=i.get(e.key);return{parameter:e,label:t?.name??e.name,icon:t?.icon}})}function bt(e,t){return!1===t.icon?V:t.icon?ct(t.icon):e.config.values.icons?ct(De(e.hass,t.parameter.entity)?.attributes.icon):V}function gt(e,t){const{text:s,muted:i}=function(e,t){const s=De(e.hass,t.entity);return s?s.state===He?{text:rt(e.hass,"not_set"),muted:!0}:Re(s.state)?{text:rt(e.hass,"unavailable"),muted:!0}:{text:Be(e.hass,s),muted:!1}:{text:rt(e.hass,"unavailable"),muted:!0}}(e,t.parameter);return W`
    <div class="row">
      <div class="row-label">
        ${bt(e,t)}<span>${t.label}</span>
      </div>
      <div class="row-value ${i?"muted":""}">${s}</div>
    </div>
  `}function $t(e,t,s,i){const n=s?t.parameter.editors[s]:void 0,r=De(e.hass,n),o=function(e,t){return"number"===e&&void 0!==t&&"slider"===mt(t,"mode","box")}(t.parameter.type,r);return W`
    <div class="row ${o?"wide":""}">
      <div class="row-label">
        ${bt(e,t)}<span>${i}</span>
      </div>
      <div class="row-control">
        ${_t(e,t.parameter.type,r,i)}
      </div>
    </div>
  `}function yt(e){if("preset"!==e.subject.kind)return V;if(!e.config.values.visible)return V;const t=e.subject.preset,s=vt(e,t);if(!s.length)return W`<div class="section note">
      ${rt(e.hass,"no_parameters")}
    </div>`;const i=null===e.subject.presetMode?W`<div class="note warning">${rt(e.hass,"orphaned")}</div>`:V,{editor:n}=e.config;if(!n.enabled)return W`
      <div class="section rows">
        ${i}${s.map(t=>gt(e,t))}
      </div>
    `;if("all"===n.mode){const t=Ke(e.subject);return W`
      <div class="section rows">
        ${i}${s.map(s=>W`
            <div class="group-label">${s.label}</div>
            ${t.map(t=>$t(e,s,t.key,t.name))}
          `)}
      </div>
    `}const r="active"===n.mode?Je(e.hass,e.subject):e.editMode;return W`
    <div class="section rows">
      ${i}${"picker"===n.mode?function(e){const t=Ke(e.subject);if(t.length<2)return V;const s=Je(e.hass,e.subject),i=t.find(e=>e.key===s);return W`
  ...
  `}(e):V}
      ${s.map(t=>$t(e,t,r,t.label))}
    </div>
  `}function wt(e){if("preset_mode"!==e.subject.kind)return V;if(!e.config.presets.visible)return V;const{presets:t}=e.subject;if(!t.length)return W`<div class="section note">
    ...
    <div class="section rows">
      ${t.map(t=>{const i=t.entities.active_mode,n=W`
        ...
        `;if(!s){const t=De(e.hass,i);return W`
          ...
          ${function(e,t){return t.parameters.map(t=>{const s=De(e.hass,t.entity);let i,n=!0;return s?s.state===He?i=rt(e.hass,"not_set"):Re(s.state)?i=rt(e.hass,"unavailable"):(i=Be(e.hass,s),n=!1):i=rt(e.hass,"unavailable"),W`
      <div class="row">
  ...
  `}function xt(e,t){const{hass:s,subject:i}=e;switch(t){case"preset_mode":return"preset"===i.kind?i.presetMode?`${rt(s,"preset_mode")}: ${i.presetMode.name}`:rt(s,"orphaned"):ot(s,"presets_one","presets_other",i.presets.length);case"blueprint":return"preset"===i.kind&&i.blueprint?`${rt(s,"blueprint")}: ${i.blueprint.name}`:null;case"source":{const e="preset_mode"===i.kind?i.presetMode.source_entity:null;if(!e)return null;const t=s.states[e];return`${rt(s,"source")}: ${t?.attributes.friendly_name??e}`}case"last_changed":{const e=De(s,Fe(i));return e?`${rt(s,"changed")}: ${function(e,t){const s=new Date(t).getTime();if(Number.isNaN(s))return"";const i=Math.round((s-Date.now())/1e3),n=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]],r=new Intl.RelativeTimeFormat(e.language||"en",{numeric:"auto"});for(const[e,t]of n)if(Math.abs(i)>=t)return r.format(Math.round(i/t),e);return r.format(Math.round(i),"second")}(s,e.last_changed)}`:null}default:return null}}const At={action:"more-info"};let kt=class extends ae{constructor(){super(...arguments),this._editModeOverride=null,this._watched=[],this._held=!1,this._lastTap=0}setConfig(e){this._config=Se(e),this._editModeOverride=null,this._watched=[]}static getConfigElement(){return document.createElement(`${e}-editor`)}static async getStubConfig(t){const s=Ne(t)??await Ue(t),i=s.preset_modes.find(e=>e.entities.mode)?.entities.mode??s.presets.find(e=>e.entities.active_mode)?.entities.active_mode;return{type:`custom:${e}`,entity:i??""}}set hass(e){const t=this._hass;if(this._hass=e,!t)return this.requestUpdate(),void this._load();if(t.language===e.language&&t.themes===e.themes){for(const s of this._watched)if(t.states[s]!==e.states[s])return void this.requestUpdate()}else this.requestUpdate()}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),this._load()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._unsubscribe=void 0,this._clearTimers()}async _load(){this._hass&&!this._unsubscribe&&(this._unsubscribe=ze(this._hass,e=>{this._structure=e}),this._structure=await Ue(this._hass))}getCardSize(){const e=this._config;if(!e)return 2;let t=e.header.visible?1:0;const s=this._subject;return"never"!==e.modes.visible&&("always"===e.modes.visible||null===s||"preset_mode"===s.kind)&&(t+=1),e.values.visible&&(t+=2),e.presets.visible&&(t+=2),e.footer.visible&&(t+=1),Math.max(1,t)}getGridOptions(){return{columns:12,min_columns:6}}get _tapAction(){return this._config?.tap_action??At}_clearTimers(){this._holdTimer&&clearTimeout(this._holdTimer),this._tapTimer&&clearTimeout(this._tapTimer),this._errorTimer&&clearTimeout(this._errorTimer),this._holdTimer=this._tapTimer=this._errorTimer=void 0}_headerDown(e){this._held=!1,We(this._config?.hold_action)&&(this._holdTimer=setTimeout(()=>{this._held=!0,this._run(this._config?.hold_action,e)},500))}_headerUp(){this._holdTimer&&clearTimeout(this._holdTimer),this._holdTimer=void 0}_headerClick(e){if(this._held)return void(this._held=!1);const t=this._config?.double_tap_action;if(!We(t))return void this._run(this._tapAction,e);const s=Date.now();if(s-this._lastTap<250)return this._tapTimer&&clearTimeout(this._tapTimer),this._tapTimer=void 0,this._lastTap=0,void this._run(t,e);this._lastTap=s,this._tapTimer=setTimeout(()=>{this._tapTimer=void 0,this._run(this._tapAction,e)},250)}_run(e,t){if(!this._hass)return;const s="preset_mode"===t.kind?t.presetMode.entities.mode:t.preset.entities.active_mode;this._call(qe(this,this._hass,e,s??this._config?.entity))}_call(e){e.then(()=>{void 0!==this._error&&(this._error=void 0)},e=>{this._error=this._messageOf(e),this._errorTimer&&clearTimeout(this._errorTimer),this._errorTimer=setTimeout(()=>{this._errorTimer=void 0,this._error=void 0},6e3)})}_messageOf(e){if("string"==typeof e)return e;if(e&&"object"==typeof e){const t=e,s=t.body;for(const e of[t.message,s?.message,t.error])if("string"==typeof e&&e)return e}return String(e)}willUpdate(e){super.willUpdate(e);const t=this._subject;this._watched=t?function(e){if("preset_mode"===e.kind){const t=tt(e.presetMode);for(const s of e.presets)t.push(...et(s));return t}const t=et(e.preset);return e.presetMode&&t.push(...tt(e.presetMode)),t}(t):[],this.dataset.density=this._config?.layout.density??"comfortable"}get _subject(){return this._config&&this._structure?st(this._structure,this._config.entity):null}_editMode(e){if(this._editModeOverride)return this._editModeOverride;const t=this._config?.editor.default_mode,s=Ke(e);return t&&s.some(e=>e.key===t)?t:Je(this._hass,e)??s[0]?.key??null}render(){const e=this._config,t=this._hass;if(!e||!t)return V;if(!this._structure)return this._shell(this._skeleton());const s=this._subject;if(!s){const s=this._structure.preset_modes.length+this._structure.presets.length;return this._shell(this._alert(s?rt(t,"not_found",{entity:e.entity}):rt(t,"not_set_up")))}const i={hass:t,config:e,subject:s,host:this,editMode:this._editMode(s),selectEditMode:e=>{this._editModeOverride=e},call:e=>this._call(e),tappable:We(this._tapAction)||We(e.hold_action),onHeaderDown:()=>this._headerDown(s),onHeaderUp:()=>this._headerUp(),onHeaderClick:()=>this._headerClick(s)};return this._shell(W`
      ${ut(i)} ${ht(i)} ${yt(i)}
      ${wt(i)} ${function(e){if(!e.config.footer.visible)return V;const t=e.config.footer.content.map(t=>xt(e,t)).filter(e=>null!==e);return t.length?W`
    <div class="section footer">
      ${t.map(e=>W`<span>${e}</span>`)}
    </div>
  `:V}(i)}
      ${this._error?W`<div class="section inline-error" role="alert">${this._error}</div>`:V}
    `)}_shell(e){const t=this._config?.appearance??{},s=[t.background?`--ha-card-background: ${t.background}`:"",t.radius?`--ha-card-border-radius: ${t.radius}`:"",!1===t.shadow?"--ha-card-box-shadow: none":"",!1===t.border?"--ha-card-border-width: 0":""].filter(Boolean).join(";");return W`<ha-card style=${s}>${e}</ha-card>`}_skeleton(){return W`
      <div class="section rows" aria-busy="true" aria-label=${rt(this._hass,"loading")}>
        <div class="skeleton" style="width:45%"></div>
        <div class="skeleton" style="width:70%"></div>
      </div>
    `}_alert(e){return Ve("ha-alert")?W`<ha-alert alert-type="warning">${e}</ha-alert>`:W`<div class="fallback-alert" role="alert">${e}</div>`}};kt.styles=at,t([ue()],kt.prototype,"_config",void 0),t([ue()],kt.prototype,"_structure",void 0),t([ue()],kt.prototype,"_editModeOverride",void 0),t([ue()],kt.prototype,"_error",void 0),kt=t([le(e)],kt);const Et={entity:"Entity",header:"Header",modes:"Modes",values:"Values",editor:"Editing",presets:"Presets",footer:"Footer",layout:"Layout",appearance:"Appearance",actions:"Actions",visible:"Show",title:"Title",subtitle:"Subtitle",icon:"Icon",icon_color:"Icon colour",style:"Style",icons:"Show icons",parameters:"Parameters",parameters_note:"Parameters",enabled:"Editable",mode:"Which mode",default_mode:"Start on",content:"Content",density:"Density",background:"Background",radius:"Corner radius",shadow:"Shadow",border:"Border",state_color:"Colour by mode",tap_action:"Tap",hold_action:"Hold",double_tap_action:"Double tap"},St=["more-info","navigate","url","perform-action","none"];function Mt(e){return{selector:{select:{mode:"dropdown",options:e.map(([e,t])=>({value:e,label:t}))}}}}let Tt=class extends ae{constructor(){super(...arguments),this._config={},this._label=e=>e.name&&Et[e.name]||e.title||e.name||""}set hass(e){this._hass=e,this._structure??=Ne(e),this._load(),this.requestUpdate()}get hass(){return this._hass}setConfig(e){this._config=e}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._unsubscribe=void 0}async _load(){this._hass&&!this._unsubscribe&&(this._unsubscribe=ze(this._hass,e=>{this._structure=e}),this._structure=await Ue(this._hass))}_hasParameterOverrides(){const e=this._config.values,t=e?.parameters;return Array.isArray(t)&&t.some(e=>"string"!=typeof e)}get _subject(){const e=this._config.entity;return this._structure&&"string"==typeof e&&e?st(this._structure,e):null}_schema(e){const t="preset"===e?.kind,s="preset_mode"===e?.kind,i=e?"preset_mode"===e.kind?e.presetMode.modes:e.preset.modes:[],n=[{name:"entity",required:!0,selector:{entity:{integration:"preset_manager"}}},{type:"expandable",name:"header",title:Et.header,schema:[{name:"visible",selector:{boolean:{}}},{name:"title",selector:{text:{}}},{name:"subtitle",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"icon_color",selector:{ui_color:{}}}]},{type:"expandable",name:"modes",title:Et.modes,schema:[{name:"visible",...Mt([["auto","Automatic"],["always","Always"],["never","Never"]])},{name:"style",...Mt([["chips","Chips"],["dropdown","Dropdown"]])},{name:"icons",selector:{boolean:{}}}]}];if(t){const t=e.preset.parameters.map(e=>({value:e.key,label:e.name}));n.push({type:"expandable",name:"values",title:Et.values,schema:[{name:"visible",selector:{boolean:{}}},this._hasParameterOverrides()?{name:"parameters_note",type:"constant",value:"Renamed parameters are edited in YAML."}:{name:"parameters",selector:{select:{multiple:!0,mode:"list",options:t}}},{name:"icons",selector:{boolean:{}}}]},{type:"expandable",name:"editor",title:Et.editor,schema:[{name:"enabled",selector:{boolean:{}}},{name:"mode",...Mt([["picker","Pick a mode in the card"],["active","The active mode"],["all","Every mode"]])},{name:"default_mode",...Mt(i.map(e=>[e.key,e.name]))}]})}return s&&n.push({type:"expandable",name:"presets",title:Et.presets,schema:[{name:"visible",selector:{boolean:{}}},{name:"values",selector:{boolean:{}}}]}),n.push({type:"expandable",name:"footer",title:Et.footer,schema:[{name:"visible",selector:{boolean:{}}},{name:"content",selector:{select:{multiple:!0,mode:"list",options:[{value:"preset_mode",label:"Preset mode"},{value:"blueprint",label:"Blueprint"},{value:"source",label:"Source entity"},{value:"last_changed",label:"Last change"}]}}}]},{type:"expandable",name:"appearance",title:Et.appearance,schema:[{name:"background",selector:{text:{}}},{name:"radius",selector:{text:{}}},{name:"shadow",selector:{boolean:{}}},{name:"border",selector:{boolean:{}}},{name:"state_color",selector:{boolean:{}}}]},{type:"expandable",name:"layout",title:Et.layout,schema:[{name:"density",...Mt([["comfortable","Comfortable"],["compact","Compact"]])}]},{type:"expandable",title:Et.actions,schema:[{name:"tap_action",selector:{ui_action:{actions:St}}},{name:"hold_action",selector:{ui_action:{actions:St}}},{name:"double_tap_action",selector:{ui_action:{actions:St}}}]}),n}_formData(){try{const t=Se({type:`custom:${e}`,...this._config,entity:this._config.entity??"sensor.placeholder"});return{...t,entity:this._config.entity??"",values:{...t.values,parameters:this._config.values?.parameters}}}catch(e){return{...this._config}}}_valueChanged(e){e.stopPropagation();Le(this,"config-changed",{config:Me({...e.detail.value})})}render(){if(!this._hass)return V;const e=this._subject;return W`
      <ha-form
        .hass=${this._hass}
        .data=${this._formData()}
    ...
    `}};t([ue()],Tt.prototype,"_config",void 0),t([ue()],Tt.prototype,"_structure",void 0),Tt=t([le(`${e}-editor`)],Tt),window.customCards=window.customCards??[],window.customCards.some(t=>t.type===e)||window.customCards.push({type:e,name:"Preset Manager",description:"The values of a preset, or the modes of a preset mode, with the mode it is on right now.",preview:!1,documentationURL:"https://github.com/julezdean/ha-preset-manager"}),console.info("%c PRESET-MANAGER-CARD %c 0.3.0b4 ","color: white; background: #03a9f4; font-weight: 700;","color: #03a9f4; background: white; font-weight: 700;");
