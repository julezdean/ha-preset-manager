...
`,It="unavailable",qt="unknown";function Bt(t){return void 0===t||t===It||t===qt}function Vt(t,e){if(t&&e)return t.states[e]}function Jt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}function Kt(t,e){if("function"==typeof t.formatEntityState)return t.formatEntityState(e);const i=e.attributes.unit_of_measurement;return i?`${e.state} ${i}`:e.state}function Ft(t){return void 0!==t&&"none"!==t.action}async function Gt(t,e,i,s){if(!i||"none"===i.action)return;const n=i.entity??s;switch(i.action){case"more-info":return void(n&&function(t,e){Jt(t,"hass-more-info",{entityId:e})}(t,n));case"toggle":return void(n&&await e.callService("homeassistant","toggle",{},{entity_id:n}));case"navigate":return void(i.navigation_path&&(r=i.navigation_path,history.pushState(null,"",r),Jt(window,"location-changed",{replace:!1})));case"url":return void(i.url_path&&window.open(i.url_path,"_blank","noreferrer"));case"perform-action":case"call-service":{const t=i.perform_action??i.service;if(!t||!t.includes("."))return;const[s,n]=t.split(".",2);return void await e.callService(s,n,i.data??i.service_data??{},i.target)}default:return}var r}function Xt(t){return"undefined"!=typeof customElements&&!!customElements.get(t)}function Yt(t,e){return function(t){const e=t?.attributes.mode_key;return"string"==typeof e&&e?e:null}(Vt(t,function(t){return t.preset.entities.active_mode}(e)))}function Zt(t){return t.preset.modes}function Qt(t,e){const i=Yt(t,e);return i?Zt(e).find(t=>t.key===i)??null:null}function te(t){return t.preset.entities.automatic}function ee(t){return t.preset.entities.mode_selection}function ie(t,e){const i=Vt(t,te(e));return!i||Bt(i.state)?null:"on"===i.state}function se(t,e){return e.presetMode&&ee(e)?ie(t,e)?"following":null:"missing"}function ne(t){return t&&Xt("ha-icon")?q`<ha-icon .icon=${t} aria-hidden="true"></ha-icon>`:V}function re(t){const{config:e}=t;if(!e.header.visible)return V;const i=function(t){const e=t.config.header.icon;if(!1===e)return null;if(e)return e;const i=Qt(t.hass,t.subject);return i?.icon??"mdi:tune-variant"}(t),s=!1===e.header.subtitle?null:e.header.subtitle??function(t){const{hass:e,subject:i}=t,s=Qt(e,i),n=s?.name??Lt(e,"no_mode");if(!i.presetMode)return`${n} · ${Lt(e,"no_preset_mode")}`;const r=ie(e,i);return null===r?n:`${n} · ${Lt(e,r?"automatic":"manual")}`}(t),n=e.header.icon_color??function(t){const e=Qt(t.hass,t.subject);return e?t.config.modes.colors[e.key]:void 0}(t),{tappable:r}=t,o=function(t){const{hass:e,subject:i,config:s}=t;if(!s.header.automatic)return V;const n=te(i);if(!n)return V;const r=ie(e,i),o=Lt(e,"mode_automatic");return q`
  ...
  `;return q`
    <div class="header section" style=${n?`--pm-icon-color: ${n}`:""}>
      ${r?q`
          ...
          `:q`<div class="header-main">${a}</div>`}
      ${o===V?V:q`<div class="header-end">${o}</div>`}
    </div>
  `}function oe(t,e,i,s){const{config:n}=t;return q`
    <div class="chips" role="group">
      ${e.map(e=>{const r=e.key===i,o=n.modes.colors[e.key];return q`
          <button
            class="chip"
            type="button"
  ...
  `}function ae(t){return function(t){const e=t.config.modes.visible;return"manual"===e?null===se(t.hass,t.subject):"never"!==e}(t)?q`<div class="section">${function(t){const e=Zt(t.subject);return e.length?oe(t,e,Yt(t.hass,t.subject),null!==se(t.hass,t.subject)):q`<div class="note">${Lt(t.hass,"no_modes")}</div>`}(t)}</div>`:V}function ce(t,e,i,s,n){if(t.stage)return void t.stage(e.entity_id,{service:i,data:s,display:n});const r=e.entity_id.split(".",1)[0];t.call(t.hass.callService(r,i,s,{entity_id:e.entity_id}))}function le(t,e){const i=t.draft?.get(e.entity_id)?.display;return void 0!==i?{disabled:!1,empty:!1,staged:i}:{disabled:(s=e.state,void 0===s||s===It),empty:Bt(e.state),staged:void 0};var s}function he(t,e,i){const s=t.attributes[e];return null==s?i:s}function de(t,e,i,s){const{disabled:n,empty:r,staged:o}=le(t,e);let a=o??(r?"":e.state);return void 0===o&&("datetime"===s&&(a=r?"":function(t){const e=new Date(t);if(Number.isNaN(e.getTime()))return"";const i=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${i(e.getMonth()+1)}-${i(e.getDate())}T${i(e.getHours())}:${i(e.getMinutes())}`}(e.state)),"time"===s&&(a=a.slice(0,5))),q`
    <input
      class="date-input"
    ...
    />
  `}function ue(t,e,i,s){if(!i)return q`<span class="row-value muted">
      ${Lt(t.hass,"unavailable")}
    </span>`;switch(e){case"number":return function(t,e,i){const{disabled:s,empty:n,staged:r}=le(t,e),o=he(e,"min",0),a=he(e,"max",100),c=he(e,"step",1),l=e.attributes.unit_of_measurement??"",h=r??e.state,d=n?"":h,u=i=>{const s=i.target.valueAsNumber;Number.isNaN(s)||ce(t,e,"set_value",{value:s},String(s))};return"slider"===he(e,"mode","box")?q`
      <input
        class="slider"
        type="range"
        aria-label=${i}
    ...
    <input
      ...
      ?disabled=${s}
      @change=${u}
      @keydown=${i=>{const n="ArrowUp"===i.key?1:"ArrowDown"===i.key?-1:0;if(!n||s)return;i.preventDefault();const r=i.target,l=Number.isNaN(r.valueAsNumber)?o:r.valueAsNumber,h=Math.min(a,Math.max(o,l+n*c));if(h===l)return;const d=(String(c).split(".")[1]??"").length;r.value=h.toFixed(d),ce(t,e,"set_value",{value:Number(r.value)},r.value)}}
    />
    ${l?q`<span class="row-value">${l}</span>`:V}
  `}(t,i,s);case"boolean":return function(t,e,i){const{disabled:s,empty:n,staged:r}=le(t,e);return q`
    <label class="switch">
      <input
        type="checkbox"
        role="switch"
  ...
  `}(t,i,s);case"select":return function(t,e,i){const{disabled:s,empty:n,staged:r}=le(t,e),o=he(e,"options",[]),a=r??e.state;return q`
    <select
      class="select-input"
      aria-label=${i}
      ?disabled=${s}
    ...
    >
      ${n?q`<option value="" selected disabled>${"—"}</option>`:V}
      ${o.map(t=>q`
  ...
  `}(t,i,s);case"text":return function(t,e,i){const{disabled:s,empty:n,staged:r}=le(t,e),o=e.attributes.pattern;return q`
    <input
      class="text-input"
      type=${"password"===he(e,"mode","text")?"password":"text"}
      aria-label=${i}
      minlength=${he(e,"min",0)}
      maxlength=${he(e,"max",255)}
      pattern=${o??V}
      .value=${n?"":r??e.state}
      ?disabled=${s}
      @change=${i=>{const s=i.target.value;ce(t,e,"set_value",{value:s},s)}}
    />
  `}(t,i,s);case"date":return de(t,i,s,"date");case"time":return de(t,i,s,"time");case"datetime":return de(t,i,s,"datetime");default:return q`<span class="row-value muted">
        ${Lt(t.hass,"not_editable")}
      </span>`}}function pe(t,e){const i=t.config.values.parameters,s=new Map((i??[]).map(t=>[t.parameter,t]));return function(t,e){if(!e)return t.parameters;const i=new Map(t.parameters.map(t=>[t.key,t]));return e.map(t=>i.get(t)).filter(t=>void 0!==t)}(e,i?i.map(t=>t.parameter):null).map(t=>{const e=s.get(t.key);return{parameter:t,label:e?.name??t.name,icon:e?.icon}})}function me(t,e,i){if(!i)return V;const s=!1===e.icon?void 0:e.icon??(t.config.values.icons?Vt(t.hass,e.parameter.entity)?.attributes.icon:void 0);return q`<span class="row-icon">${ne(s)}</span>`}function fe(t,e,i){const{text:s,muted:n}=function(t,e){const i=Vt(t.hass,e.entity);return i?i.state===qt?{text:Lt(t.hass,"not_set"),muted:!0}:Bt(i.state)?{text:Lt(t.hass,"unavailable"),muted:!0}:{text:Kt(t.hass,i),muted:!1}:{text:Lt(t.hass,"unavailable"),muted:!0}}(t,e.parameter);return q`
    <div class="row">
      <div class="row-label">
  ...
  `}function _e(t,e,i,s,n){const r=i?e.parameter.editors[i]:void 0,o=Vt(t.hass,r),a=function(t,e){return"number"===t&&void 0!==e&&"slider"===he(e,"mode","box")}(e.parameter.type,o);return q`
  ...
  `}function ve(t){if(!t.config.values.visible)return V;const e=t.subject.preset,i=pe(t,e);if(!i.length)return q`<div class="section note">
      ${Lt(t.hass,"no_parameters")}
    </div>`;const s=null===t.subject.presetMode?q`<div class="note warning">${Lt(t.hass,"orphaned")}</div>`:V,n=function(t,e){return t.config.values.icons||e.some(t=>"string"==typeof t.icon)}(t,i),r=t.draft.size?function(t){return q`
    <div class="toolbar">
  ...
  `}(t):V,o=t.config.values.mode;if("active"===o)return q`
      <div class="section rows">
        ${s}${i.map(e=>fe(t,e,n))}
      </div>
    `;if("all"===o){const e=Zt(t.subject);return q`
      <div class="section rows">
        ${s}
        ${i.map(i=>q`
    ...
    `}if("edit"===o){const e=Yt(t.hass,t.subject);return q`
      <div class="section rows">
        ${s}
        ${i.map(i=>_e(t,i,e,i.label,n))}
        ${r}
      </div>
    `}const a=t.editMode;return q`
    <div class="section rows">
      ${s}${function(t){const e=Zt(t.subject);if(!e.length)return V;const i=Lt(t.hass,"mode"),s=t.editMode;return q`
    <div class="row">
      ...
      <div class="row-control">
        <div class="chips secondary" role="group" aria-label=${i}>
          <button
            ...
            @click=${()=>t.selectEditMode(null)}
          >
            <span>${Lt(t.hass,"active")}</span>
          </button>
          ${e.map(e=>q`
              <button
                class="chip"
  ...
  `}const ge={action:"more-info"};let be=class extends at{constructor(){super(...arguments),this._draft=new Map,this._watched=[],this._held=!1,this._lastTap=0}setConfig(t){this._config=At(t),this._viewMode=void 0,this._draft=new Map,this._watched=[]}static getConfigElement(){return document.createElement(`${t}-editor`)}static async getStubConfig(e){const i=Ot(e)??await Pt(e),s=i.presets.find(t=>t.entities.active_mode)?.entities.active_mode;return{type:`custom:${t}`,entity:s??""}}set hass(t){const e=this._hass;if(this._hass=t,!e)return this.requestUpdate(),void this._load();if(e.language===t.language&&e.themes===t.themes){for(const i of this._watched)if(e.states[i]!==t.states[i])return void this.requestUpdate()}else this.requestUpdate()}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),this._load()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._unsubscribe=void 0,this._clearTimers()}async _load(){this._hass&&!this._unsubscribe&&(this._unsubscribe=jt(this._hass,t=>{this._structure=t}),this._structure=await Pt(this._hass))}getCardSize(){const t=this._config;if(!t)return 2;let e=t.header.visible?1:0;return"never"!==t.modes.visible&&(e+=1),t.values.visible&&(e+=2),Math.max(1,e)}getGridOptions(){return{columns:12,min_columns:6}}get _tapAction(){return this._config?.tap_action??ge}_clearTimers(){this._holdTimer&&clearTimeout(this._holdTimer),this._tapTimer&&clearTimeout(this._tapTimer),this._errorTimer&&clearTimeout(this._errorTimer),this._holdTimer=this._tapTimer=this._errorTimer=void 0}_headerDown(t){this._held=!1,Ft(this._config?.hold_action)&&(this._holdTimer=setTimeout(()=>{this._held=!0,this._run(this._config?.hold_action,t)},500))}_headerUp(){this._holdTimer&&clearTimeout(this._holdTimer),this._holdTimer=void 0}_headerClick(t){if(this._held)return void(this._held=!1);const e=this._config?.double_tap_action;if(!Ft(e))return void this._run(this._tapAction,t);const i=Date.now();if(i-this._lastTap<250)return this._tapTimer&&clearTimeout(this._tapTimer),this._tapTimer=void 0,this._lastTap=0,void this._run(e,t);this._lastTap=i,this._tapTimer=setTimeout(()=>{this._tapTimer=void 0,this._run(this._tapAction,t)},250)}_run(t,e){if(!this._hass)return;const i=e.preset.entities.active_mode;this._call(Gt(this,this._hass,t,i??this._config?.entity))}_apply(){if(!this._hass||!this._draft.size)return;const t=this._hass,e=[...this._draft].map(([e,i])=>t.callService(e.split(".",1)[0],i.service,i.data,{entity_id:e}));this._draft=new Map,this._viewMode=void 0,this._call(Promise.all(e))}_call(t){t.then(()=>{void 0!==this._error&&(this._error=void 0)},t=>{this._error=this._messageOf(t),this._errorTimer&&clearTimeout(this._errorTimer),this._errorTimer=setTimeout(()=>{this._errorTimer=void 0,this._error=void 0},6e3)})}_messageOf(t){if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t,i=e.body;for(const t of[e.message,i?.message,e.error])if("string"==typeof t&&t)return t}return String(t)}willUpdate(t){super.willUpdate(t);const e=this._subject;this._watched=e?function(t){const e=Nt(t.preset);return t.presetMode&&e.push(...zt(t.presetMode)),e}(e):[]}get _subject(){return this._config&&this._structure?Ht(this._structure,this._config.entity):null}_viewedMode(){return this._viewMode??null}render(){const t=this._config,e=this._hass;if(!t||!e)return V;if(!this._structure)return this._shell(this._skeleton());const i=this._subject;if(!i){let i;return i=this._structure.preset_modes.length+this._structure.presets.length?function(t,e){return t.preset_modes.some(t=>zt(t).includes(e))}(this._structure,t.entity)?Lt(e,"not_a_preset",{entity:t.entity}):Lt(e,"not_found",{entity:t.entity}):Lt(e,"not_set_up"),this._shell(this._alert(i))}const s={hass:e,config:t,subject:i,host:this,editMode:this._viewedMode(),selectEditMode:t=>{this._viewMode=t},call:t=>this._call(t),draft:this._draft,stage:(t,e)=>{this._draft=new Map(this._draft).set(t,e)},apply:()=>this._apply(),discard:()=>{this._draft=new Map},tappable:Ft(this._tapAction)||Ft(t.hold_action),onHeaderDown:()=>this._headerDown(i),onHeaderUp:()=>this._headerUp(),onHeaderClick:()=>this._headerClick(i)};return this._shell(q`
    ...
    `}_alert(t){return Xt("ha-alert")?q`<ha-alert alert-type="warning">${t}</ha-alert>`:q`<div class="fallback-alert" role="alert">${t}</div>`}};be.styles=Wt,e([ut()],be.prototype,"_config",void 0),e([ut()],be.prototype,"_structure",void 0),e([ut()],be.prototype,"_viewMode",void 0),e([ut()],be.prototype,"_draft",void 0),e([ut()],be.prototype,"_error",void 0),be=e([lt(t)],be);const ye={entity:"Entity",header:"Header",modes:"Modes",values:"Values",actions:"Actions",visible:"Show",automatic:"Automatic switch",title:"Title",subtitle:"Subtitle",icon:"Icon",icon_color:"Icon colour",icons:"Show icons",parameters:"Parameters",parameters_note:"Parameters",mode:"Which mode",content:"Content",tap_action:"Tap",hold_action:"Hold",double_tap_action:"Double tap"},$e=["more-info","navigate","url","perform-action","none"];function we(t){return{selector:{select:{mode:"dropdown",options:t.map(([t,e])=>({value:t,label:e}))}}}}let xe=class extends at{constructor(){super(...arguments),this._config={},this._label=t=>t.name&&ye[t.name]||t.title||t.name||""}set hass(t){this._hass=t,this._structure??=Ot(t),this._load(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){this._config=t}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._unsubscribe=void 0}async _load(){this._hass&&!this._unsubscribe&&(this._unsubscribe=jt(this._hass,t=>{this._structure=t}),this._structure=await Pt(this._hass))}_entityPicker(){const t=(this._structure?.presets??[]).map(t=>t.entities.active_mode).filter(t=>Boolean(t));return t.length?{include_entities:t}:{integration:"preset_manager"}}_hasParameterOverrides(){const t=this._config.values,e=t?.parameters;return Array.isArray(e)&&e.some(t=>"string"!=typeof t)}get _subject(){const t=this._config.entity;return this._structure&&"string"==typeof t&&t?Ht(this._structure,t):null}_schema(t){const e=t?t.preset.modes:[],i=[{name:"entity",required:!0,selector:{entity:this._entityPicker()}},{type:"expandable",name:"header",title:ye.header,schema:[{name:"visible",selector:{boolean:{}}},{name:"automatic",selector:{boolean:{}}},{name:"title",selector:{text:{}}},{name:"subtitle",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"icon_color",selector:{ui_color:{}}}]},{type:"expandable",name:"modes",title:ye.modes,schema:[{name:"visible",...we([["always","Always"],["never","Never"],["manual","While the mode can be set by hand"]])},...e.some(t=>t.icon)?[{name:"icons",selector:{boolean:{}}}]:[]]}];if(t){const e=t.preset.parameters.map(t=>({value:t.key,label:t.name}));i.push({type:"expandable",name:"values",title:ye.values,schema:[{name:"visible",selector:{boolean:{}}},{name:"mode",...we([["active","Show the active values"],["picker","Pick a mode in the card"],["edit","Edit the active mode"],["all","Every mode at once"]])},this._hasParameterOverrides()?{name:"parameters_note",type:"constant",value:"Renamed parameters are edited in YAML."}:{name:"parameters",selector:{select:{multiple:!0,mode:"list",options:e}}},{name:"icons",selector:{boolean:{}}}]})}return i.push({type:"expandable",title:ye.actions,schema:[{name:"tap_action",selector:{ui_action:{actions:$e}}},{name:"hold_action",selector:{ui_action:{actions:$e}}},{name:"double_tap_action",selector:{ui_action:{actions:$e}}}]}),i}_formData(){try{const e=At({type:`custom:${t}`,...this._config,entity:this._config.entity??"sensor.placeholder"});return{...e,entity:this._config.entity??"",values:{...e.values,parameters:this._config.values?.parameters}}}catch(t){return{...this._config}}}_valueChanged(t){t.stopPropagation();Jt(this,"config-changed",{config:kt({...t.detail.value})})}render(){if(!this._hass)return V;const t=this._subject;return q`
      ...
      ></ha-form>
      ${this._config.entity&&!t&&this._structure?q`<p style="color: var(--error-color)">
            ${Lt(this._hass,"not_found",{entity:String(this._config.entity)})}
          </p>`:V}
    `}};e([ut()],xe.prototype,"_config",void 0),e([ut()],xe.prototype,"_structure",void 0),xe=e([lt(`${t}-editor`)],xe),window.customCards=window.customCards??[],window.customCards.some(e=>e.type===t)||window.customCards.push({type:t,name:"Preset Manager",description:"The values of a preset, with the mode it is on right now.",preview:!1,documentationURL:"https://github.com/julezdean/ha-preset-manager"}),console.info("%c PRESET-MANAGER-CARD %c 0.4.0-beta.10 ","color: white; background: #03a9f4; font-weight: 700;","color: #03a9f4; background: white; font-weight: 700;");
