...
`;function dt(e){return e&&Ve("ha-icon")?W`<ha-icon .icon=${e} aria-hidden="true"></ha-icon>`:V}function ht(e){const{visible:t}=e.config.modes;return"never"!==t&&("always"===t||"preset_mode"===e.subject.kind)}function ut(e,t,s){const i=t.entities.active_mode;i&&e.call(e.hass.callService("preset_manager","set_active_mode",{mode:s},{entity_id:i}))}function pt(e){if(!ht(e))return V;const t=Xe(e.subject);if(!t.length)return W`<div class="section note">
      ${at(e.hass,"no_modes")}
    </div>`;const s=function(e){return e.subject.presetMode}(e),i=Ke(e.hass,e.subject),n=null!==Qe(e.hass,s),r=function(e,t){const s=Qe(e.hass,t);if("automatic"===s)return at(e.hass,"automatic_hint");if("external"===s&&t?.source_entity){const s=e.hass.states[t.source_entity];return at(e.hass,"external_hint",{entity:s?.attributes.friendly_name??t.source_entity})}return"missing"===s&&"preset"===e.subject.kind?at(e.hass,"orphaned"):null}(e,s);return W`
    <div class="section">
      ${"dropdown"===e.config.modes.style?function(e,t,s,i,n){return W`
    <select
      class="select-input"
      aria-label=${at(e.hass,"preset_mode")}
      ?disabled=${n}
      @change=${t=>{const s=t.target.value;i&&ut(e,i,s)}}
    >
      ${null===s?W`<option value="" selected>${at(e.hass,"no_mode")}</option>`:V}
      ${t.map(e=>W`
    ...
    <div class="chips" role="group">
      ${t.map(t=>{const o=t.key===s,a=r.modes.colors[t.key];return W`
          <button
            ...
            @click=${()=>i&&ut(e,i,t.key)}
          >
            ${r.modes.icons?dt(t.icon):V}
            <span>${t.name}</span>
          </button>
        `})}
    </div>
  ...
  `}function mt(e){const{config:t}=e;if(!t.header.visible)return V;const s=function(e){const t=e.config.header.icon;if(!1===t)return null;if(t)return t;const s=Ye(e.hass,e.subject);return s?.icon?s.icon:"preset_mode"===e.subject.kind?"mdi:state-machine":"mdi:tune-variant"}(e),i=!1===t.header.subtitle?null:t.header.subtitle??function(e){const{hass:t,subject:s}=e,i=Ye(t,s),n=i?.name??at(t,"no_mode");if("preset_mode"===s.kind){const{presetMode:e}=s;if(e.source_entity){const s=t.states[e.source_entity];return`${n} · ${at(t,"follows",{entity:s?.attributes.friendly_name??e.source_entity})}`}return n}return s.presetMode?`${n} · ${s.presetMode.name}`:`${n} · ${at(t,"no_preset_mode")}`}(e),n=t.header.icon_color??function(e){const t=Ye(e.hass,e.subject);return t?e.config.modes.colors[t.key]:void 0}(e),{tappable:r}=e,o="preset_mode"===e.subject.kind||ht(e)?function(e){const{hass:t,subject:s}=e,i=s.presetMode;if(!i?.entities.automatic)return V;const n=i.entities.automatic,r=Ze(t,i),o=at(t,"automatic"),a=e=>e.stopPropagation();return W`
    <label
      class="switch"
      title=${o}
      @click=${a}
  ...
  `}function ft(e,t,s,i){const n=t.entity_id.split(".",1)[0];e.call(e.hass.callService(n,s,i,{entity_id:t.entity_id}))}function _t(e){return{disabled:(t=e.state,void 0===t||t===He),empty:Re(e.state)};var t}function vt(e,t,s){const i=e.attributes[t];return null==i?s:i}function bt(e,t,s,i){const{disabled:n,empty:r}=_t(t);let o=r?"":t.state;return"datetime"===i&&(o=r?"":function(e){const t=new Date(e);if(Number.isNaN(t.getTime()))return"";const s=e=>String(e).padStart(2,"0");return`${t.getFullYear()}-${s(t.getMonth()+1)}-${s(t.getDate())}T${s(t.getHours())}:${s(t.getMinutes())}`}(t.state)),"time"===i&&(o=o.slice(0,5)),W`
    <input
      class="date-input"
  ...
  `}(e,s,i);case"date":return bt(e,s,i,"date");case"time":return bt(e,s,i,"time");case"datetime":return bt(e,s,i,"datetime");default:return W`<span class="row-value muted">
        ${at(e.hass,"not_editable")}
      </span>`}}function $t(e,t){return"number"===e&&void 0!==t&&"slider"===vt(t,"mode","box")}function yt(e,t){const s=e.config.values.parameters,i=new Map((s??[]).map(e=>[e.parameter,e]));return function(e,t){if(!t)return e.parameters;const s=new Map(e.parameters.map(e=>[e.key,e]));return t.map(e=>s.get(e)).filter(e=>void 0!==e)}(t,s?s.map(e=>e.parameter):null).map(e=>{const t=i.get(e.key);return{parameter:e,label:t?.name??e.name,icon:t?.icon}})}function wt(e,t,s){if(!s)return V;const i=!1===t.icon?void 0:t.icon??(e.config.values.icons?De(e.hass,t.parameter.entity)?.attributes.icon:void 0);return W`<span class="row-icon">${dt(i)}</span>`}function xt(e,t,s){const{text:i,muted:n}=function(e,t){const s=De(e.hass,t.entity);return s?s.state===ze?{text:at(e.hass,"not_set"),muted:!0}:Re(s.state)?{text:at(e.hass,"unavailable"),muted:!0}:{text:Be(e.hass,s),muted:!1}:{text:at(e.hass,"unavailable"),muted:!0}}(e,t.parameter);return W`
    <div class="row">
      <div class="row-label">
  ...
  `}function At(e,t,s,i,n){const r=s?t.parameter.editors[s]:void 0,o=De(e.hass,r),a=$t(t.parameter.type,o);return W`
  ...
  `}function kt(e){if("preset"!==e.subject.kind)return V;if(!e.config.values.visible)return V;const t=e.subject.preset,s=yt(e,t);if(!s.length)return W`<div class="section note">
      ${at(e.hass,"no_parameters")}
    </div>`;const i=null===e.subject.presetMode?W`<div class="note warning">${at(e.hass,"orphaned")}</div>`:V,n=function(e,t){return e.config.values.icons||t.some(e=>"string"==typeof e.icon)}(e,s),{editor:r}=e.config;if(!r.enabled)return W`
    ...
    <div class="group-label">${at(e.hass,"editing")}</div>
    <div class="chips" role="group" aria-label=${at(e.hass,"editing")}>
      ${t.map(t=>W`
          <button
            class="chip"
            type="button"
          ...
          >
            ${e.config.modes.icons?dt(t.icon):V}
            <span>${t.name}</span>
          </button>
        `)}
    </div>
    ${i&&i.key!==e.editMode?W`<div class="note">
          ${at(e.hass,"active_is",{mode:i.name})}
        </div>`:V}
  `}(e):V}
      ${s.map(t=>At(e,t,o,t.label,n))}
    </div>
  `}function Et(e,t){const s=e.config.presets.editable;return t.parameters.map(i=>{const n=s&&$t(i.type,De(e.hass,i.editors[Ge(e.hass,t)??""]));return W`
  ...
  `}(e,t,i):function(e,t){const s=De(e.hass,t.entity);let i,n=!0;return s?s.state===ze?i=at(e.hass,"not_set"):Re(s.state)?i=at(e.hass,"unavailable"):(i=Be(e.hass,s),n=!1):i=at(e.hass,"unavailable"),W`<div class="row-value ${n?"muted":""}">${i}</div>`}(e,i)}
      </div>
    `})}function St(e,t){const{hass:s,subject:i}=e;switch(t){case"preset_mode":return"preset"===i.kind?i.presetMode?`${at(s,"preset_mode")}: ${i.presetMode.name}`:at(s,"orphaned"):ct(s,"presets_one","presets_other",i.presets.length);case"blueprint":return"preset"===i.kind&&i.blueprint?`${at(s,"blueprint")}: ${i.blueprint.name}`:null;case"source":{const e="preset_mode"===i.kind?i.presetMode.source_entity:null;if(!e)return null;const t=s.states[e];return`${at(s,"source")}: ${t?.attributes.friendly_name??e}`}case"last_changed":{const e=De(s,Je(i));return e?`${at(s,"changed")}: ${function(e,t){const s=new Date(t).getTime();if(Number.isNaN(s))return"";const i=Math.round((s-Date.now())/1e3),n=[["year",31536e3],["month",2592e3],["day",86400],["hour",3600],["minute",60]],r=new Intl.RelativeTimeFormat(e.language||"en",{numeric:"auto"});for(const[e,t]of n)if(Math.abs(i)>=t)return r.format(Math.round(i/t),e);return r.format(Math.round(i),"second")}(s,e.last_changed)}`:null}default:return null}}const Mt={action:"more-info"};let Tt=class extends ae{constructor(){super(...arguments),this._editModeOverride=null,this._watched=[],this._held=!1,this._lastTap=0}setConfig(e){this._config=Ee(e),this._editModeOverride=null,this._watched=[]}static getConfigElement(){return document.createElement(`${e}-editor`)}static async getStubConfig(t){const s=Ue(t)??await Oe(t),i=s.preset_modes.find(e=>e.entities.mode)?.entities.mode??s.presets.find(e=>e.entities.active_mode)?.entities.active_mode;return{type:`custom:${e}`,entity:i??""}}set hass(e){const t=this._hass;if(this._hass=e,!t)return this.requestUpdate(),void this._load();if(t.language===e.language&&t.themes===e.themes){for(const s of this._watched)if(t.states[s]!==e.states[s])return void this.requestUpdate()}else this.requestUpdate()}get hass(){return this._hass}connectedCallback(){super.connectedCallback(),this._load()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._unsubscribe=void 0,this._clearTimers()}async _load(){this._hass&&!this._unsubscribe&&(this._unsubscribe=Ne(this._hass,e=>{this._structure=e}),this._structure=await Oe(this._hass))}getCardSize(){const e=this._config;if(!e)return 2;let t=e.header.visible?1:0;const s=this._subject;return"never"!==e.modes.visible&&("always"===e.modes.visible||null===s||"preset_mode"===s.kind)&&(t+=1),e.values.visible&&(t+=2),e.presets.visible&&(t+=2),e.footer.visible&&(t+=1),Math.max(1,t)}getGridOptions(){return{columns:12,min_columns:6}}get _tapAction(){return this._config?.tap_action??Mt}_clearTimers(){this._holdTimer&&clearTimeout(this._holdTimer),this._tapTimer&&clearTimeout(this._tapTimer),this._errorTimer&&clearTimeout(this._errorTimer),this._holdTimer=this._tapTimer=this._errorTimer=void 0}_headerDown(e){this._held=!1,We(this._config?.hold_action)&&(this._holdTimer=setTimeout(()=>{this._held=!0,this._run(this._config?.hold_action,e)},500))}_headerUp(){this._holdTimer&&clearTimeout(this._holdTimer),this._holdTimer=void 0}_headerClick(e){if(this._held)return void(this._held=!1);const t=this._config?.double_tap_action;if(!We(t))return void this._run(this._tapAction,e);const s=Date.now();if(s-this._lastTap<250)return this._tapTimer&&clearTimeout(this._tapTimer),this._tapTimer=void 0,this._lastTap=0,void this._run(t,e);this._lastTap=s,this._tapTimer=setTimeout(()=>{this._tapTimer=void 0,this._run(this._tapAction,e)},250)}_run(e,t){if(!this._hass)return;const s="preset_mode"===t.kind?t.presetMode.entities.mode:t.preset.entities.active_mode;this._call(qe(this,this._hass,e,s??this._config?.entity))}_call(e){e.then(()=>{void 0!==this._error&&(this._error=void 0)},e=>{this._error=this._messageOf(e),this._errorTimer&&clearTimeout(this._errorTimer),this._errorTimer=setTimeout(()=>{this._errorTimer=void 0,this._error=void 0},6e3)})}_messageOf(e){if("string"==typeof e)return e;if(e&&"object"==typeof e){const t=e,s=t.body;for(const e of[t.message,s?.message,t.error])if("string"==typeof e&&e)return e}return String(e)}willUpdate(e){super.willUpdate(e);const t=this._subject;this._watched=t?function(e){if("preset_mode"===e.kind){const t=it(e.presetMode);for(const s of e.presets)t.push(...st(s));return t}const t=st(e.preset);return e.presetMode&&t.push(...it(e.presetMode)),t}(t):[]}get _subject(){return this._config&&this._structure?nt(this._structure,this._config.entity):null}_editMode(e){if(this._editModeOverride)return this._editModeOverride;const t=this._config?.editor.default_mode,s=Xe(e);return t&&s.some(e=>e.key===t)?t:Ke(this._hass,e)??s[0]?.key??null}render(){const e=this._config,t=this._hass;if(!e||!t)return V;if(!this._structure)return this._shell(this._skeleton());const s=this._subject;if(!s){const s=this._structure.preset_modes.length+this._structure.presets.length;return this._shell(this._alert(s?at(t,"not_found",{entity:e.entity}):at(t,"not_set_up")))}const i={hass:t,config:e,subject:s,host:this,editMode:this._editMode(s),selectEditMode:e=>{this._editModeOverride=e},call:e=>this._call(e),tappable:We(this._tapAction)||We(e.hold_action),onHeaderDown:()=>this._headerDown(s),onHeaderUp:()=>this._headerUp(),onHeaderClick:()=>this._headerClick(s)};return this._shell(W`
      ${mt(i)} ${pt(i)} ${kt(i)}
      ...
      ${ct(e.hass,"presets_one","presets_other",0)}
        ...
        `;if(!s){const t=De(e.hass,i);return W`
            <div class="row">
              ...
              <div class="row-value ${t&&!Re(t.state)?"":"muted"}">
                ${t&&!Re(t.state)?t.state:at(e.hass,"no_mode")}
              </div>
            </div>
          `}return W`
  ...
  `}(i)} ${function(e){if(!e.config.footer.visible)return V;const t=e.config.footer.content.map(t=>St(e,t)).filter(e=>null!==e);return t.length?W`
  ...
  `:V}(i)}
    ...
    `)}_shell(e){return W`<ha-card>${e}</ha-card>`}_skeleton(){return W`
      <div class="section rows" aria-busy="true" aria-label=${at(this._hass,"loading")}>
        <div class="skeleton" style="width:45%"></div>
        <div class="skeleton" style="width:70%"></div>
      </div>
    `}_alert(e){return Ve("ha-alert")?W`<ha-alert alert-type="warning">${e}</ha-alert>`:W`<div class="fallback-alert" role="alert">${e}</div>`}};Tt.styles=lt,t([ue()],Tt.prototype,"_config",void 0),t([ue()],Tt.prototype,"_structure",void 0),t([ue()],Tt.prototype,"_editModeOverride",void 0),t([ue()],Tt.prototype,"_error",void 0),Tt=t([le(e)],Tt);const Pt={entity:"Entity",header:"Header",modes:"Modes",values:"Values",editor:"Editing",presets:"Presets",footer:"Footer",actions:"Actions",visible:"Show",title:"Title",subtitle:"Subtitle",icon:"Icon",icon_color:"Icon colour",style:"Style",icons:"Show icons",parameters:"Parameters",parameters_note:"Parameters",enabled:"Editable",editable:"Editable",mode:"Which mode",default_mode:"Start on",content:"Content",tap_action:"Tap",hold_action:"Hold",double_tap_action:"Double tap"},Ct=["more-info","navigate","url","perform-action","none"];function jt(e){return{selector:{select:{mode:"dropdown",options:e.map(([e,t])=>({value:e,label:t}))}}}}let Ot=class extends ae{constructor(){super(...arguments),this._config={},this._label=e=>e.name&&Pt[e.name]||e.title||e.name||""}set hass(e){this._hass=e,this._structure??=Ue(e),this._load(),this.requestUpdate()}get hass(){return this._hass}setConfig(e){this._config=e}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._unsubscribe=void 0}async _load(){this._hass&&!this._unsubscribe&&(this._unsubscribe=Ne(this._hass,e=>{this._structure=e}),this._structure=await Oe(this._hass))}_entityPicker(){const e=[...(this._structure?.preset_modes??[]).map(e=>e.entities.mode),...(this._structure?.presets??[]).map(e=>e.entities.active_mode)].filter(e=>Boolean(e));return e.length?{include_entities:e}:{integration:"preset_manager"}}_hasParameterOverrides(){const e=this._config.values,t=e?.parameters;return Array.isArray(t)&&t.some(e=>"string"!=typeof e)}get _subject(){const e=this._config.entity;return this._structure&&"string"==typeof e&&e?nt(this._structure,e):null}_schema(e){const t="preset"===e?.kind,s="preset_mode"===e?.kind,i=e?"preset_mode"===e.kind?e.presetMode.modes:e.preset.modes:[],n=[{name:"entity",required:!0,selector:{entity:this._entityPicker()}},{type:"expandable",name:"header",title:Pt.header,schema:[{name:"visible",selector:{boolean:{}}},{name:"title",selector:{text:{}}},{name:"subtitle",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"icon_color",selector:{ui_color:{}}}]},{type:"expandable",name:"modes",title:Pt.modes,schema:[{name:"visible",...jt([["auto","Automatic"],["always","Always"],["never","Never"]])},{name:"style",...jt([["chips","Chips"],["dropdown","Dropdown"]])},{name:"icons",selector:{boolean:{}}}]}];if(t){const t=e.preset.parameters.map(e=>({value:e.key,label:e.name}));n.push({type:"expandable",name:"values",title:Pt.values,schema:[{name:"visible",selector:{boolean:{}}},this._hasParameterOverrides()?{name:"parameters_note",type:"constant",value:"Renamed parameters are edited in YAML."}:{name:"parameters",selector:{select:{multiple:!0,mode:"list",options:t}}},{name:"icons",selector:{boolean:{}}}]},{type:"expandable",name:"editor",title:Pt.editor,schema:[{name:"enabled",selector:{boolean:{}}},{name:"mode",...jt([["picker","Pick a mode in the card"],["active","The active mode"],["all","Every mode"]])},{name:"default_mode",...jt(i.map(e=>[e.key,e.name]))}]})}return s&&n.push({type:"expandable",name:"presets",title:Pt.presets,schema:[{name:"visible",selector:{boolean:{}}},{name:"values",selector:{boolean:{}}},{name:"editable",selector:{boolean:{}}}]}),n.push({type:"expandable",name:"footer",title:Pt.footer,schema:[{name:"visible",selector:{boolean:{}}},{name:"content",selector:{select:{multiple:!0,mode:"list",options:[{value:"preset_mode",label:"Preset mode"},{value:"blueprint",label:"Blueprint"},{value:"source",label:"Source entity"},{value:"last_changed",label:"Last change"}]}}}]},{type:"expandable",title:Pt.actions,schema:[{name:"tap_action",selector:{ui_action:{actions:Ct}}},{name:"hold_action",selector:{ui_action:{actions:Ct}}},{name:"double_tap_action",selector:{ui_action:{actions:Ct}}}]}),n}_formData(){try{const t=Ee({type:`custom:${e}`,...this._config,entity:this._config.entity??"sensor.placeholder"});return{...t,entity:this._config.entity??"",values:{...t.values,parameters:this._config.values?.parameters}}}catch(e){return{...this._config}}}_valueChanged(e){e.stopPropagation();Le(this,"config-changed",{config:Se({...e.detail.value})})}render(){if(!this._hass)return V;const e=this._subject;return W`
      <ha-form
        .hass=${this._hass}
        .data=${this._formData()}
      ...
      ${this._config.entity&&!e&&this._structure?W`<p style="color: var(--error-color)">
            ${at(this._hass,"not_found",{entity:String(this._config.entity)})}
          </p>`:V}
